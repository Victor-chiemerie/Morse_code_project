...
> This project includes decoding of the morse_code message using Ruby program.

## Getting Started

This repository includes files with decoder.rb file that contains a program that decodes the morse code message string
...
**[Morse_code_project]** is a project that was was done to decode a morse_code string message.
** Schema diagram (ERD)** 
...
```sh
  cd my-folder
  git clone https://github.com/Victor-chiemerie/Morse_code_project.git
```
--->
